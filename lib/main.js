...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield createPackageZip(packageZipOutPath, packageNameFromXml, packageVersion);
            // YAY all done :)
        }
        catch (error) {
...
function createBuildUmbTmp() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (fs.existsSync(BUILD_PKG_FOLDER)) {
            ...
            yield io.rmRF(BUILD_PKG_FOLDER);
        }
        // Create the folder so it's empty & squeeky clean
        yield io.mkdirP(BUILD_PKG_FOLDER);
    });
}
...
function createPackageZip(packageOutPath, packageName, packageVersion) {
    return __awaiter(this, void 0, void 0, function* () {
